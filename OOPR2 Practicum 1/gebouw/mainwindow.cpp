...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    //d1=new Draaideur(295, 290, 30, false);
    //d2=new Draaideur(248, 140, 40, true);

    //deuren.push_back(new Schuifdeur(503,250,80,s1)); // Voordeur toevoegen aan de vector
    //deuren.push_back(new Draaideur(248, 140, 40, true));// d1 toevoegen aan de vector
    //deuren.push_back(new Draaideur(295, 290, 30, false));//d2 toevoegen aan de vector

    s1 = std::make_unique<HallSensor>(515, 160);
    deuren.push_back(std::make_unique<Schuifdeur>(503, 250, 80, s1.get()));
    deuren.push_back(std::make_unique<Draaideur>(248, 140, 40, true));
    deuren.push_back(std::make_unique<Draaideur>(295, 290, 30, false));
}
